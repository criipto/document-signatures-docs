...
2. Next, you must acquire a production certificate for the eID provider(s) you wish to use in production. More on how to do that [can be found here](/verify/eids).
