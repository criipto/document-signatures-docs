...
The language is selected based on [either ui_locales or Accept-Language](http://localhost:8000/verify/guides/choose-language/)
...
```html
<i18n
  da="Ved at logge ind accepterer du vores vildkår for brug"
