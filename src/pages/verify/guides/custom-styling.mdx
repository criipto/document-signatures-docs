...
1. [Adding custom CSS](#custom-css), if your goal is to add basic styling
2. [Adding custom HTML](#custom-html) for creating more complex UIs (e.g. a layout with extra information around the Criipto login box).

## Custom CSS

Custom CSS can be configured from the `Styling` -> `General` tab of your management dashboard on [dashboard.criipto.com](https://dashboard.criipto.com/styling).
...
The preview of the user-facing dialogs with your custom HTML will be rendered as you save your code (`Save draft`). You can see the preview with different eIDs and screen sizes by selecting the desired values from the dropdowns: 
...
For inspiration, you can check out various examples of custom UIs [here](/verify/articles/custom-ui-samples). 
