...
- [DK MitID for business](/verify/eids/danish-mitid/#business)
...
Note that specifically for [Danish MitID](/verify/eids/danish-mitid), you may also send a base64-url-encoded message via `message:BASE64URL(...text...)`, which will be shown to the end user in the MitID app.
