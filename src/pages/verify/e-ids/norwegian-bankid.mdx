...
The application for Biometrics is identical as the one you will find below, but must also contain information about, whether your company is MVA obliged or not. 
