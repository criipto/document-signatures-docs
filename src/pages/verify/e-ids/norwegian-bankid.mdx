...
5. Person registered in the business registry with authorization to sign the agreement: _Name, mobile phone and email_
6. Your company’s Norwegian bank: _Name, organisation number, and address_
7. Contact person with authorization to block/revoke the use of BankID: _Name, mobile phone, and email_
8. Contact person with authorization to receive the client credentials and client secret: _Name, mobile phone, and email_
...
11. The URL of your production domain as setup in step 4 of the [Getting ready for production](/verify/guides/production)
12. If you need access to social security numbers (“fødselsnummer”) please provide brief explanation of why and reference the Norwegian law and paragraph that grant you the right
