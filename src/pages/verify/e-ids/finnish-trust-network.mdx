...
When you send the End Customer Agreement to us, please provide us with your tenant support link and the production domain from your Criipto tenant, that you wish to run FTN logins via.
