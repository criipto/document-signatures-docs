...
The _required_ minimum height of the red rectangle is 588 pixels, and it is _strongly recommended_ that you always allow the MitID UI elements to fill out the entire viewport on mobile devices.
