...
- `scope (string)`: Can be used to specify the user data you want on a per-authorize request basis. To start using this feature, activate the "Enable dynamic scopes" toggle in your application settings. Read more [here](./getting-started/oidc-intro/#the-scope-parameter).
