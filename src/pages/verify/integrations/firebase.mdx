...
subtitle: This tutorial demonstrates how to integrate Criipto Verify with Firebase Authentication with Identity Platform.
---
...
The Identity Platform supports OpenID Connect authentication, so you can leverage Criipto as an OpenID Connect provider to authenticate your users in web apps, on Android, and on Apple platforms.
...
Once you registered your login application at Criipto Verify, you will have access to the following information necessary for leveraginf Criipto as an OpenID Connect provider in Firebase Authentication with Identity Platform:
...
- **Domain** which you will use as an Issuer URL in Firebase. We used `samples.criipto.id` in this example.
...
9. You will now configure the OIDC integration. Copy the Firebase Callback URL and add it into the "Callback URL" field in your Criipto Dashboard.
   ![Callback URL in Criipto Dashboard](./firebase/criipto-dashboard-callback-url.png)
10. Form this point, you can follow the steps for the platform of your choice to integrate Firebase into your application.
    In a web application, you can handle the sign-in flow [with the Firebase SDK](https://firebase.google.com/docs/auth/web/openid-connect#handle_the_sign-in_flow_with_the_firebase_sdk), or [manually](https://firebase.google.com/docs/auth/web/openid-connect#manual).
    These two options are also available on both [iOS](https://firebase.google.com/docs/auth/ios/openid-connect#handle_the_sign-in_flow_with_the_firebase_sdk) and [Android](https://firebase.google.com/docs/auth/android/openid-connect#handle_the_sign-in_flow_with_the_firebase_sdk)
