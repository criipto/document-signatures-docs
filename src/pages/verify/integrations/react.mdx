...
sort: 0
title: React
subtitle: Accept MitID, NemID, Swedish BankID, Norwegian BankID and more logins in your React app with @criipto/verify-react.
---
import Layout from '../../../layouts/mdx';
export default Layout;

This guide shows you how to use Criipto Verify in a React web application. 

Read the [full documentation](https://github.com/criipto/criipto-verify-react) or [download a sample application from GitHub](https://github.com/criipto/criipto-verify-react/tree/master/example).
