...
For example, if you are developing your application in Expo Go, the callback URL may look like this: `exp://127.0.0.1:8081`.
...
<a href="https://docs.expo.dev/guides/deep-linking/" target="_blank">Guide to Expo universal links</a>.
